<div wire:ignore.self class="p-4">
    ...
    <div class="flex flex-row pb-2 justify-between ">
        <h3 class="font-bold">Add Resident</h3>
    ...
    <form wire:submit.prevent="submit" id="add-resident-form">
