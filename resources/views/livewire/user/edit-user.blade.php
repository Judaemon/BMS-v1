        ...
        @wire
            ...
            <section>
                ...
                <div class="pl-3 grid grid-cols-1 md:grid-cols-6 xl:grid-cols-12 gap-4 mb-4">
                    ...
                    <div class="col-span-6">
                        <x-form-input placeholder="P.O Box 1234, Baguio Post Office" name="user.address_1"
                            label="address 1" />
                    </div>

                    <div class="col-span-6">
                        <x-form-input placeholder="P.O Box 5678, Baguio Post Office" name="user.address_2"
                            label="address 2" />
                    </div>
                    ...
                    <div class="col-span-5 text-">
                        ...
                        <div class="flex flex-row space-x-2">
                            ...
                            <p class="font-thin text-xs text-justify">
                                The default password is the first letter of the first name then "." then the full last name.
                                e.g.,
